...
export default function Premium() {
    ...
    return (
        <Stack data-aos="fade-up" data-aos-duration="2000">
            <Paper sx={styles.customPaper} elevation={3} >
                <Stack>
                    <Typography align="center" variant="h4">Basic</Typography>
                    <Typography align="center" py={2} component='span' variant="h3" color="blue">47$<Typography component='span' color="#CCCCCC">/year</Typography></Typography>
                </Stack>
                <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Typography variant="paragraph" sx={styles.deleteItem}><Done sx={{ width: 40, color: '#808080' }} /> Lorem ipsum dolor sit amet</Typography>
                    <Typography variant="paragraph" sx={styles.deleteItem}><Done sx={{ width: 40, color: '#808080' }} /> Lorem ipsum dolor sit amet</Typography>
